				...
				<div class="row">
                    ...
                    <div class="card shadow mr-4 col" style="padding:0px" >
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">리뷰추가</h6>
                        </div>
                        <div class="card-body ">
							<form name="form1" method="post" enctype="multipart/form-data" class="user">
							  <div class="row">
								  <div class="form-group col">
									 <div class="row mx-1">
										<input type="text" class="form-control form-control-user col mr-1" name="jangbu_no" placeholder="예약번호">
							  ...
							  <div class="row">
								  <div class="form-group col">
									 <div class="row mx-1">
										...
										<input type="text" class="form-control form-control-user col mr-1" name="member_name" placeholder="예약자명" Readonly>
									 </div>
										<?php if(form_error("member_name")==true) echo form_error("member_name"); ?>
								  </div>
								  <div class="form-group col">
									<div class="row mx-1">
										...
										<input type="text" class="form-control form-control-user col mr-1" name="room_name" placeholder="객실명" Readonly>
									</div>
							  ...
							  <div class="form-group">
								<textarea class="form-control form-control-user" name="review" placeholder="후기"></textarea>
							  </div>
