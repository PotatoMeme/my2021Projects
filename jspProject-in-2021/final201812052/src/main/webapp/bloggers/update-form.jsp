            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form action="update.do" method="post" id="contactForm" class="user">
                            <input type="hidden" name="id" value="${requestScope.blogger.id}"/>
                            <input type="hidden" name="rank" value="${requestScope.blogger.rank}"/>
                            <input type="hidden" name="sessionid" value="${logined.id}"/>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input name="pw" value="${requestScope.blogger.pw}"type="password" class="form-control form-control-user" id="password"
                            ...
                            <button class="btn btn-primary btn-user btn-block" id="submitButton" type="submit" >  Update </button>
                        </form>
